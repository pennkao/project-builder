...
const MultiSelect = ({ label, options, defaultSelected = [], value, onChange, disabled = false, placeholder = 'Select options' }: MultiSelectProps) => {
    ...
    const handleSelect = (optionValue: string) => {
        const newSelected = selectedOptions.includes(optionValue) ? selectedOptions.filter((v) => v !== optionValue) : [...selectedOptions, optionValue];
                        ...
                        >
                            <div className="flex flex-wrap flex-auto gap-2">
                                {selectedOptions.length > 0 ? (
                                    ...
                                    <div className="w-full h-full p-1 pr-2 text-sm text-gray-400 dark:text-gray-500 pointer-events-none">{placeholder}</div>
                                )}
                            </div>
